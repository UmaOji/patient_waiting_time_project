...
WHERE entry_date NOT REGEXP '^[0-9]{4}-[0-9]{2}-[0-9]{2}$' -- To keep the date in the YYYY-MM-DD format
   OR entry_time NOT REGEXP '^[0-9]{2}:[0-9]{2}:[0-9]{2}$' -- To keep the time in the HH:MM:SS format
